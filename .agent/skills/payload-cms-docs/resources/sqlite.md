...
For more information about migrations, see the [Migrations](./migrations.md) documentation.
...
> **Note**: This adapter is currently in beta as it is new and could be subject to changes which may be considered breaking
