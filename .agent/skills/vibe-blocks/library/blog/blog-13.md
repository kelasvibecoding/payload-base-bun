...
## Metadata
- **Category**: Blog
- **Objective**: Image-Left List
- **Use Case**: Horizontal card layout with left-aligned images.
- **Visual Style**: Side-by-side image and text.
- **Interactivity**: Horizontal scanning.
