...
## Metadata
- **Category**: Blog
- **Objective**: Vertical List Layout
- **Use Case**: Mobile-optimized single-column blog listing.
- **Visual Style**: Stacked full-width cards.
- **Interactivity**: Scroll-based navigation.
