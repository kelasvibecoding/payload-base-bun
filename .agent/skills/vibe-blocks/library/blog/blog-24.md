...
## Metadata
- **Category**: Blog
- **Objective**: Mixed Media Masonry
- **Use Case**: Blogs with varied content types (video, images, text).
- **Visual Style**: Multi-format card masonry.
- **Interactivity**: Media type indicators.
