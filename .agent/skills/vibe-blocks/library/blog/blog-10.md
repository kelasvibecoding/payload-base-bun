...
## Metadata
- **Category**: Blog
- **Objective**: Featured + Grid Hybrid
- **Use Case**: Highlighting one main post with supporting grid.
- **Visual Style**: Large featured card + smaller grid items.
- **Interactivity**: Priority-based layout.
