...
## Metadata
- **Category**: Blog
- **Objective**: Excerpt-Rich Blog Grid
- **Use Case**: Long-form content previews with substantial excerpts.
- **Visual Style**: Extended description text on cards.
- **Interactivity**: Read more navigation.
