...
## Metadata
- **Category**: Blog
- **Objective**: Compact Blog Grid
- **Use Case**: Dense content listing for high-volume blogs with minimal spacing.
- **Visual Style**: Tight 3-column grid with compact card design.
- **Interactivity**: Direct post navigation.
