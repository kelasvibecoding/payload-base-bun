...
## Metadata
- **Category**: Blog
- **Objective**: Category-Filtered Blog Grid
- **Use Case**: Standard blog listing with category navigation and 3-column grid layout.
- **Visual Style**: 3-column grid with category filter buttons and featured images.
- **Interactivity**: Category filtering, Post card navigation.
