...
## Metadata
- **Category**: Blog
- **Objective**: Category-Grouped List
- **Use Case**: Content organized by category sections.
- **Visual Style**: Section headers with grouped items.
- **Interactivity**: Category-based browsing.
