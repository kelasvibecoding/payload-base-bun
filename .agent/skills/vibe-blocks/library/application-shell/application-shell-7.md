...
- **Objective**: Sidebar + Split (Left Interaction)
- **Use Case**: The ultimate layout for data-heavy apps requiring both global nav and a persistent local sub-navigator.
- **Visual Style**: Global vertical Sidebar + Left-side secondary panel.
- **Interactivity**: Multi-level vertical navigation state management.
