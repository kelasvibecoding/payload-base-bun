...
- **Objective**: Clean Sidebar Navigation
- **Use Case**: Standard dashboard layout. Focuses purely on vertical navigation for high-density tools.
- **Visual Style**: Vertical sidebar with navigation items and footer user profile.
- **Interactivity**: Sidebar navigation, Dropdown menus, Accordions for nested links.
