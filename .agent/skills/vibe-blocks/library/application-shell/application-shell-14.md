...
- **Objective**: Sticky Side Panel (Right Information)
- **Use Case**: Best for data-entry forms that need a persistent summary, help panel, or checklist on the right.
- **Visual Style**: Top nav architect with a sticky secondary right panel.
- **Interactivity**: Context-aware right-hand information display.
