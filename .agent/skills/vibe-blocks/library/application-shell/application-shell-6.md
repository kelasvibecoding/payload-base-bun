...
- **Objective**: Split Layout (Right-Heavy)
- **Use Case**: Best for contextual information, property panels, or help docs on the right side of the main view.
- **Visual Style**: Top nav + Right-side secondary panel split.
- **Interactivity**: Layout-specific triggers for right-hand information management.
