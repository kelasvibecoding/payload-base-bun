...
- **Objective**: Sticky Side Panel (Left Navigator)
- **Use Case**: Perfect for documentation or settings where a persistent sub-navigator is needed below the top-nav.
- **Visual Style**: Top nav architect with a sticky secondary left panel.
- **Interactivity**: Sub-navigation scrolling and section tracking.
