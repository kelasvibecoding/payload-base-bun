...
- **Objective**: Standard Top Nav
- **Use Case**: Best for sites wanting a traditional "website" feel with full-width content.
- **Visual Style**: Horizontal navigation with logo, nav links, search, and user profile.
- **Interactivity**: Mobile-responsive menu, search reveal, notification dropdown, user settings dropdown.

## Description
A classic top-navigation focused shell suitable for marketing websites or simple web applications.
