...
- **Objective**: Split Layout (Left-Heavy)
- **Use Case**: Ideal when you need a secondary sub-menu or local tools container on the left of the main content.
- **Visual Style**: Top nav + Left-side secondary panel split.
- **Interactivity**: Top-level navigation + local contextual panel control.
