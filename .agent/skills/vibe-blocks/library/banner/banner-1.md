...
- **Use Case**: Best for newsletters or early-access signups at the top of a page.
- **Visual Style**: Email input + primary signup button.
- **Interactivity**: Form submission handling, visibility toggle (close button).
