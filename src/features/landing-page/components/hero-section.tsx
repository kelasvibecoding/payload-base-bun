  ...
  return (
    <section className="relative z-0 flex min-h-[100dvh] flex-col items-center justify-center px-4 text-center">
      <div className="max-w-4xl space-y-8">
        ...
        <h1 className="animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150 fill-mode-both font-outfit text-5xl font-extrabold tracking-tight leading-[1.1] sm:text-7xl md:text-8xl">
        ...
        <p className="animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 fill-mode-both mx-auto max-w-2xl text-lg text-muted-foreground sm:text-xl leading-relaxed">
          Experience the &quot;LightDay Galaxy&quot; aesthetic. A premium, high-performance foundation built with Payload CMS and Next.js.
        </p>

        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 fill-mode-both flex flex-col items-center justify-center gap-4 sm:flex-row">
