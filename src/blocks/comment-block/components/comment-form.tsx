        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              />
              {errors.name && (
                <span className="text-destructive text-sm">{errors.name.message as string}</span>
              )}
            </div>
            <div className="grid gap-2">
              ...
              />
              {errors.email && (
                <span className="text-destructive text-sm">{errors.email.message as string}</span>
              )}
            </div>
            <div className="grid gap-2">
              ...
              />
              {errors.comment && (
                <span className="text-destructive text-sm">{errors.comment.message as string}</span>
              )}
            </div>
          </CardContent>
          <CardFooter
