            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  _status === 'draft' ? 'border-primary rounded-md border p-1' : '',
                )}
              >
                {_status === 'draft' && (
                  <Link
                    className="bg-background absolute -top-3 right-10 rounded-md border border-black px-3 dark:border-white"
