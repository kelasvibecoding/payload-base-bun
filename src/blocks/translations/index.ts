...
export const blogBlockTranslations = {
  ...
  blogDescription: {
    en: 'Discover insights, tutorials, and stories from our team.',
    id: 'Temukan wawasan, tutorial, dan cerita dari tim kami.',
  },
  by: {
    en: 'By',
    id: 'Oleh',
  ...
  linkCopied: {
    ...
    id: 'Tautan disalin ke papan klip!',
  },
  failedToCopy: {
